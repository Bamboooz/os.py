...
print('ipv6', network.get_ipv6())
print('Subnet mask: ', network.get_subnet_mask())
print('Default gateway: ', network.get_default_gateway())
print('Is user connected to the internet: ', network.is_connected())
print('Hostname: ', network.get_hostname())
print('Ping time: ', network.get_ping_time())
print('Download speed: ', network.user_download_speed())
print('Upload speed: ', network.user_upload_speed())
